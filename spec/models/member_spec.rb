...
describe Member do
  ...
  describe 'is_admin' do
    it 'should return true is role on the member is admin' do
      admin_member = FactoryGirl.create :member, :role => 'admin'
      non_admin_member = FactoryGirl.create :member, :email => "foo#{rand(10)}@bar.com"
  ...
  describe 'is_member_of?' do
    it 'should return true if given house name is equal to house name of member' do
      ...
      another_member = FactoryGirl.create(:member, :house => another_house, :email => "foo#{rand(10)}@bar.com")
